...
document.getElementById("video__btn").addEventListener("click", function() {
  if(btn_status == 0) {
    video.play();
    btn_status = 1;
  }else {
...
var video__wrapper = document.getElementById("video__wrapper");

video__wrapper.addEventListener("mouseover", function() {
  video.setAttribute("controls", "controls");
});
video__wrapper.addEventListener("mouseout", function() {
